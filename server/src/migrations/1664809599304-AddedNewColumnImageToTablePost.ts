...
export class AddedNewColumnImageToTablePost1664809599304 implements MigrationInterface {
    name = 'AddedNewColumnImageToTablePost1664809599304'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "posts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "content" character varying NOT NULL, "imageId" uuid, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "REL_294625b251f17eca44cc57fbeb" UNIQUE ("imageId"), CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))`);
