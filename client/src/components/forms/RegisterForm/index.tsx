    ...
    <section className="bg-white">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        <aside className="relative block h-16 lg:order-last lg:col-span-5 lg:h-full xl:col-span-6">
          <img alt="Pattern" src="/background-1.jfif" className="absolute inset-0 h-full w-full object-cover" />
        </aside>
        ...
        >
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <h1 className="mt-6 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl">Welcome to GorongGoring</h1>

            <p className="mt-4 leading-relaxed text-gray-500">Create your account</p>

            <form onSubmit={handleSubmit(prepareSubmit)} className="mt-8 grid grid-cols-6 gap-6">
              ...
              <div className="col-span-6">
                <Label>
                  Email
                  <Input {...register('email')} type="email" errorMessage={errors.email?.message} />
                </Label>
              </div>
              ...
              <div className="col-span-6 sm:col-span-3">
                <Label>
                  ...
                  <Input {...register('password2')} type="password" errorMessage={errors.password2?.message} />
                </Label>
              </div>
